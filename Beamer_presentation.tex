...
\begin{frame}
  ...
  Read through the example concerning the Hadamard operator starting at the buttom of 16 continuing to page 17 in the notes.
...
\begin{frame}
 ...
 Did you get the pun? 
  ...
  \includegraphics[width=7.5cm]{img/completely-different.png}
    ...
    \end{tikzpicture}
  \end{center}
  \uncover<2->{Monty Python $\to$ IBM Q \emph{is} related $\to$ IBM Q uses \emph{Python} $\to$ Python is named after Monty Python, \uncover<3>{\alert{because programming should be fun!}}}
\end{frame}
